...
def build_semantic_tree_from_fhir(fhir_data: Dict[str, Any], patient_id: str, age: int) -> HealthRecordSemanticTree:
    ...
    # Extract conditions, medications, encounters from FHIR
    conditions_raw = []
    medications_raw = []
    encounters_raw = []
    ...
    pregnancy_profile = extract_pregnancy_profile(conditions_raw, encounters_raw, age, comorbidity_index)
