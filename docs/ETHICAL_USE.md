# Ethical Use Guidelines - v1.2.0

**Project:** Gravidas - Persona-to-Health-Record Matching System
**Phase:** Phase 4, Task 3.2 - Ethical Use Guidelines
**Version:** 1.2.0
**Date:** 2025-11-17
**Status:** ✅ COMPLETE
...
**Example Disclosure:**
> "This study uses synthetic maternal health data generated by the Gravidas system (v1.2.0), which creates artificial personas and simulated clinical interviews. No real patient data was used in this analysis."
...
This study uses synthetic data generated by Gravidas v1.2.0, which has the following potential biases:
...
**Full Citation:**
```
Polônia, D. (2025). Gravidas: A Synthetic Healthcare Interview Generation System for Maternal Health Research (Version 1.2.0) [Software]. GitHub. https://github.com/yourusername/202511-Gravidas
```
...
```
Polônia, D. (2025). Synthetic Maternal Health Interview Dataset (Generated by Gravidas v1.2.0) [Dataset]. [Repository]. DOI: [if applicable]
```
...
1. **Version Number:** Specify exact version (e.g., v1.2.0)
